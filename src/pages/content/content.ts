...
export class ContentPage {
  ...
  public items : any = [];
    ...
    // for the record data
    createEntry(startt, endd, dated, timed, sit, brand, color, tel)
    {
       let body     : string   = "key=create&startt=" + startt + "&endd=" + endd + "&dated=" +
       dated + "&timed=" + timed + "&sit=" + sit +
    ...
    // for the record data
    updateEntry(startt, endd, dated, timed, sit, brand, color, tel)
    {
    ...
    saveEntry()
    {
       ...
       if(this.isEdited)
       {
          this.updateEntry(startt, endd, dated, timed, sit, brand, color, tel);
       }
       else
       {
          this.createEntry(startt, endd, dated, timed, sit, brand, color, tel);
       }
    }
